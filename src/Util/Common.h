...
void iterateInDirection(Direction direction, unsigned lower_bound,
	unsigned upper_bound, F action)
{
	switch (direction) {
...
// Loops the 2D cells in a random order to minimize bias towards a certain direction
template <typename F>
